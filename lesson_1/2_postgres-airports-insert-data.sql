...
(3, 3, 'U6250', 'Транзитный', 7000, '21:00:00', '05:00:00', '08:00:00', 'По четным дням'),
(4, 4, 'P2345', 'Терминальный', 2500, '18:00:00', '20:00:00', '02:00:00', 'По выходным'),
(5, 5, 'N7890', 'Транзитный', 4500, '07:00:00', '11:30:00', '04:30:00', 'Каждую среду'),
(1, 6, 'SU200', 'Терминальный', 5500, '10:00:00', '17:00:00', '07:00:00', 'Ежедневно'),
(2, 7, 'S7151', 'Терминальный', 3200, '11:00:00', '14:00:00', '03:00:00', 'По нечетным дням'),
(3, 8, 'U6280', 'Транзитный', 8000, '23:00:00', '07:00:00', '08:00:00', 'По понедельникам'),
(4, 9, 'P2456', 'Терминальный', 2700, '19:00:00', '21:30:00', '02:30:00', 'По четным дням'),
(5, 10, 'N7901', 'Транзитный', 4800, '08:00:00', '12:45:00', '04:45:00', 'Каждую пятницу'),
(6, 1, 'SU1234', 'Терминальный', 5300, '08:00:00', '14:00:00', '06:00:00', 'Ежедневно'),
(7, 2, 'P7890', 'Транзитный', 4300, '09:30:00', '15:00:00', '05:30:00', 'По будням');


-- Data Insert into TABLE Events:

INSERT INTO Events (airport_id, flight_id, type, date, del_adv_time, status) VALUES 
(1, 1, 'Вылет', '2023-11-01', '10:00:00', 'Состоялся'),
(5, 1, 'Посадка', '2023-11-01', '15:00:00', 'Ожидается'),
(2, 2, 'Вылет', '2023-11-01', '09:00:00', 'Состоялся'),
(6, 2, 'Посадка', '2023-11-01', '12:30:00', 'Ожидается'),
(3, 3, 'Вылет', '2023-11-01', '21:00:00', 'Ожидается'),
(7, 3, 'Посадка', '2023-11-02', '05:00:00', 'Состоялся'),
(4, 4, 'Вылет', '2023-11-01', '18:00:00', 'Ожидается'),
(8, 4, 'Посадка', '2023-11-01', '20:00:00', 'Ожидается'),
(5, 5, 'Вылет', '2023-11-01', '07:00:00', 'Состоялся'),
(9, 5, 'Посадка', '2023-11-01', '11:30:00', 'Состоялся'),
(6, 6, 'Вылет', '2023-11-01', '10:00:00', 'Состоялся'),
(1, 6, 'Посадка', '2023-11-01', '17:00:00', 'Ожидается'),
(7, 7, 'Вылет', '2023-11-01', '11:00:00', 'Состоялся'),
(2, 7, 'Посадка', '2023-11-01', '14:00:00', 'Ожидается'),
(8, 8, 'Вылет', '2023-11-01', '23:00:00', 'Ожидается'),
(3, 8, 'Посадка', '2023-11-02', '07:00:00', 'Состоялся'),
(9, 9, 'Вылет', '2023-11-01', '19:00:00', 'Ожидается'),
(4, 9, 'Посадка', '2023-11-01', '21:30:00', 'Ожидается'),
(1, 10, 'Вылет', '2023-11-01', '08:00:00', 'Состоялся'),
(5, 10, 'Посадка', '2023-11-01', '14:00:00', 'Ожидается');
